...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"HotDaily" withExtension:@"momd"];
...
//    }
//    
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"HotDaily.sqlite"];
//    
//    NSError *error = nil;
